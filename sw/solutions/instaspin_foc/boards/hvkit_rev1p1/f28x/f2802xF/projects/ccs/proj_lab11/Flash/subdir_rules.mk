...
proj_lab11.obj: D:/Foc/my_motor/sw/solutions/instaspin_foc/src/proj_lab11.c $(GEN_OPTS) $(GEN_HDRS)
	@echo 'Building file: $<'
	@echo 'Invoking: C2000 Compiler'
	"c:/ti/ccsv6/tools/compiler/c2000_6.2.5/bin/cl2000" -v28 -ml -mt -O2 --include_path="D:/Foc/my_motor/sw/modules/hal/boards/hvkit_rev1p1/f28x/f2802x/src/" --include_path="c:/ti/ccsv6/tools/compiler/c2000_6.2.5/include" --include_path="D:/Foc/my_motor/sw/solutions/instaspin_foc/boards/hvkit_rev1p1/f28x/f2802xF/src" --include_path="D:/Foc/my_motor" -g --define=FLASH --define=FAST_ROM_V1p7 --define=F2802xF --define=NO_CTRL --diag_warning=225 --display_error_number --asm_listing --preproc_with_compile --preproc_dependency="proj_lab11.pp" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: $<'
	@echo ' '
